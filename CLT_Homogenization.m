...
% Author: Paul Davidson, pauldave@umich.edu
% Part of AIAA Material TC code repository initative.
% =============================================== %
clear all;
...
for j=1:1:length(t)*N
    ...
    L(j).Q=[ (E1(km)/(1-v12(km)*v21(km))) (v12(km)*E2(km)/(1-v12(km)*v21(km))) 0;
        (v21(km)*E2(km)/(1-v12(km)*v21(km))) (E2(km)/(1-v12(km)*v21(km))) 0;
        0 0 G12(km)];
    ...
    L(j).T2=[ cos(a(i))^2 sin(a(i))^2 2*cos(a(i))*sin(a(i));
        sin(a(i))^2 cos(a(i))^2 -2*cos(a(i))*sin(a(i));
